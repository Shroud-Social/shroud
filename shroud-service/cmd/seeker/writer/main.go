...
func main() {
	...
	log.Println("Shroud Seeker Writer service started")

	sigchan := make(chan os.Signal, 1)
	signal.Notify(sigchan, syscall.SIGINT, syscall.SIGTERM)
	<-sigchan
	log.Println("Shroud Seeker Writer service shutting down...")
	...
	log.Println("Shroud Seeker Writer service shut down")
}
